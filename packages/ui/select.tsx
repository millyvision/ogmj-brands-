...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      // OGMJ Premium styling
      "text-gray-300 focus:bg-emerald-500/10 focus:text-emerald-400 data-[highlighted]:bg-emerald-500/10 data-[highlighted]:text-emerald-400",
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-muted", "bg-gray-800", className)}
    {...props}
  />
))
