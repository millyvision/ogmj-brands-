  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        emerald: "bg-emerald-500/10 border-emerald-500/20 text-emerald-400 [&>svg]:text-emerald-400",
        gold: "bg-yellow-500/10 border-yellow-500/20 text-yellow-400 [&>svg]:text-yellow-400",
        ...
        glass: "glass-dark border-gray-700 text-gray-300 [&>svg]:text-gray-400",
      },
    },
    defaultVariants: {
      variant: "default",
